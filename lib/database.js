...
function Database() {
    ...
    this.getDb = function(app, propParentSpan, callback) {
        const parentSpan = propParentSpan ? propParentSpan : tracer.startSpan('get_db', { 'kind':opentelemetry.SpanKind.CLIENT });
